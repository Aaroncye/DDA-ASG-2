        ...
        if (snapshot.exists()) {
            ...
            try {
                ...
                snapshot.forEach((childSnapshot) => {
                    ...
                    <td>Strikes Made: ${childSnapshot.child("strikes").val()}</td>
                    <td>Missed Spares: ${childSnapshot.child("missedSpares").val()}</td>
                    <td>Time taken to play: ${childSnapshot.child("timeTakenToPlay").val().toFixed(2) + "h"}</td>
